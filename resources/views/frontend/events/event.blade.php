...
@section('content')
  ...
  <div class="main-content">
            ...
            {{-- <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg.jpg">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                      <div class="schedule-box maxwidth500 bg-light mb-30">
                        <div class="thumb">
                          ...
                          <img style="height: 160px;" class="img-fullwidth" alt="" src="{{url('')}}/{{ $objEvent->Photo->photo }}">
                          @else
                        ...
                        <div class="schedule-details clearfix p-15 pt-10">
                          <h5 class="font-16 title"><a href="#">{{$objEvent->topics}}</a></h5>
