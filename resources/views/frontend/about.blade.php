    ...
    <section class="">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h6 class="letter-space-4 text-gray-darkgray text-uppercase mt-0 mb-0">{{__('messages.allabout')}}</h6>
              <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom">{{__('messages.besteducat')}}</h2>
              <h4 class="text-theme-colored">{{__('messages.loremheader')}}</h4>
            <p>{{__('messages.loremcontent')}}</p>
              <a class="btn btn-theme-colored btn-flat btn-lg mt-10 mb-sm-30" href="#">{{__('messages.knowmore')}}</a>
            </div>
            <div class="col-md-6">
    ...
    <section id="services" class="bg-lighter">
      <div class="container">
        <div class="section-title">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase text-theme-colored title line-bottom"> @if(Request::segment(1)=='ar') @elseif(Request::segment(1)=='en') {{__('messages.our')}} @endif <span class="text-theme-color-2 font-weight-400">{{__('messages.features')}}</span></h2>
            </div>
          </div>
        </div>
